...
function SSEAssignedLeads() {
  ...
  const fetchLeads = useCallback(async () => {
    try {
      setLoading(true)
      let data = []
      data = await leadService.getAssignedLeads()
      console.log(data)
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    {["Lead ID", "Lead Priority", "Middle Man Client Name", "Proposal Type", "Product Type","Assigned SSE",'Approval Status','Shared Status' ,"Actions"]
                      .filter(Boolean)
                      .map((header) => (
                        <th
                          key={header}
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          ...
                          <span
                            ...
                            >
                            {lead.salestl_approval_status === '1' ? 'Yes' : lead.salestl_approval_status === '0' ? 'No' : 'Pending' }
                            </span>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4">
                          ...
                          <span
                            ...
                            >
                            {lead.salestl_shared_status === '1' ? 'Yes' : lead.salestl_shared_status === '0' ? 'No' : 'Pending' }
                            </span>
                          </div>
                        </td>
