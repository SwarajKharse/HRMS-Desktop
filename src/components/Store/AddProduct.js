...
const AddProduct = ({ onClose, onSuccess }) => {
  ...
  // Load categories when main group changes
  useEffect(() => {
  ...
  const loadMainGroups = async () => {
    try {
      ...
      //const response = await fetch(`${process.env.REACT_APP_API_URL}/store/getallmaingroups`)
  ...
  const loadCategories = async (mainGroupId) => {
    try {
      ...
      //const response = await fetch(`${process.env.REACT_APP_API_URL}/store/getcategoriesbymaingroup/${mainGroupId}`)
  ...
  const loadSubcategories = async (categoryId) => {
    try {
      ...
      //const response = await fetch(`${process.env.REACT_APP_API_URL}/store/getsubcategoriesbycategory/${categoryId}`)
  ...
  const createMainGroup = async () => {
    try {
      /* const response = await fetch(`${process.env.REACT_APP_API_URL}/store/createmaingroup`, {
        method: "POST",
      ...
      const response = await storeService.createMainGroup(JSON.stringify({
        group_name: newItems.mainGroup.name,
        id: null
      }))
  ...
  const createCategory = async () => {
    try {
      /* const response = await fetch(`${process.env.REACT_APP_API_URL}/store/createcategory`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
      ...
      const response = await storeService.createCategory(JSON.stringify({
        category_name: newItems.category.name,
        mainGroupId: formData.mainGroupId,
        id: null
      }))
  ...
  const createSubcategory = async () => {
    try {
      /* const response = await fetch(`${process.env.REACT_APP_API_URL}/store/createsubcategory`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
      ...
      const response = await storeService.createSubcategory(JSON.stringify({
        category_name: newItems.subcategory.name,
        productCategoryId: formData.categoryId,
        id: null
      }))
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      /* const response = await fetch(`${process.env.REACT_APP_API_URL}/store/createproduct`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
      ...
      const response = await storeService.createProduct(JSON.stringify({
        product_name: formData.productName,
        product_description: formData.productDescription,
        uom: formData.uom,
        hsn_code: formData.hsnCode,
