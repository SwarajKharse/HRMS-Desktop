  ...
  const permissionGroups = {
    app: {
      ...
      permissions: [
        ...
        { key: "appSurveysDownload", label: "Surveys Download" },
        { key: "appAmc", label: "AMC" },
        { key: "appAmcDownload", label: "AMC Download" },
        ...
        { key: "appHelp", label: "Help" },
        { key: "appHrOptions", label: "HR Options" },
        { key: "appReports", label: "Reports" },
        { key: "appSettings", label: "Settings" },
        { key: "appOnboarding", label: "Onboarding" },
      ],
    },
    webSurvey: {
